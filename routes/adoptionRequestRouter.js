...
/**
 * @swagger
 * /api/request/adoption-request/{id}:
 *   get:
 ...
 *         name: id
 *         required: true
 *         description: The ID of the adoption request
 *         schema:
 *           type: string
 */
router.get('/adoption-request/:id', verifyToken, AdoptionRequestController.getAdoptionRequestById);
